...
function(CUDA_SELECT_NVCC_ARCH_FLAGS out_variable)
  set(CUDA_ARCH_LIST "8.0")
  #set(CUDA_ARCH_LIST "${ARGN}")
   
  if("X${CUDA_ARCH_LIST}" STREQUAL "X" )
    set(CUDA_ARCH_LIST "Auto")
  endif()
  set(arch_name "Ampere")
  set(cuda_arch_bin)
  set(cuda_arch_ptx)
  ...
  message("---- >>>  0. HEREEE cuda PTX!!!!!!!!!!!!!!")

  # Now process the list and look for names
  string(REGEX REPLACE "[ \t]+" ";" CUDA_ARCH_LIST "${CUDA_ARCH_LIST}")
  list(REMOVE_DUPLICATES CUDA_ARCH_LIST)
  message("---- >>>  1. HEREEE cuda PTX!!!!!!!!!!!!!!")
  foreach(arch_name ${CUDA_ARCH_LIST})
    message("---- >>>  2. HEREEE cuda PTX!!!!!!!!!!!!!!")
    #set(arch_bin)
    #set(arch_ptx 8.0)
    set(arch_bin 8.0)
    set(arch_ptx 8.0)
    ...
    set(arch_ptx 8.0)
    message("---- >>>  HEREEE cuda ${arch_name} PTX!!!!!!!!!!!!!!")
    endif()
    if(NOT arch_bin)
  ...
  foreach(arch ${cuda_arch_bin})
    if(arch MATCHES "([0-9]+)\\(([0-9]+)\\)")
      message("---- >>>  3-0. HEREEE cuda PTX!!!!!!!!!!!!!!")
      # User explicitly specified ARCH for the concrete CODE
      list(APPEND nvcc_flags -gencode arch=compute_${CMAKE_MATCH_2},code=sm_${CMAKE_MATCH_1})
      list(APPEND nvcc_archs_readable sm_${CMAKE_MATCH_1})
    else()
      message("---- >>>  3-1. HEREEE cuda PTX!!!!!!!!!!!!!!")
  ...
  foreach(arch ${cuda_arch_ptx})
    message("---- >>>  3-2. HEREEE cuda PTX!!!!!!!!!!!!!!")
    list(APPEND nvcc_flags -keep -gencode arch=compute_${arch},code=compute_${arch})
    list(APPEND nvcc_archs_readable compute_${arch})
  endforeach()

  string(REPLACE ";" " " nvcc_archs_readable "${nvcc_archs_readable}")
  set(${out_variable}          ${nvcc_flags}          PARENT_SCOPE)
  message("---- >>>  3-3. FLAGS =nvcc_flagss} !!!!!!!!!!!!!!")
